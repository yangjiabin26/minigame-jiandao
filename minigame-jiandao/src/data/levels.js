...
const LEVELS = [
  { // L1 山谷：教学关，3 敌兵
    theme: 'valley', w: 750, h: 1000, reward: 15,
  ...
  { // L2 山谷：引入弓箭手
    theme: 'valley', w: 750, h: 1100, reward: 20,
  ...
  { // L3 森林：引入盾兵
    theme: 'forest', w: 800, h: 1100, reward: 25,
  ...
  { // L6 城堡：狂战士群
    theme: 'castle', w: 800, h: 1200, reward: 35,
  ...
  { // L7 城堡：大混战
    theme: 'castle', w: 850, h: 1300, reward: 40,
  ...
  { // L8 城堡 Boss：黑骑士单挑
    theme: 'castle', w: 800, h: 1000, boss: 'blackknight', reward: 80,
    obstacles: [],
    spawns: [],
    playerStart: { x: 400, y: 900 }, exit: { x: 400, y: 80 },
  },
